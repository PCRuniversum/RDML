...
Our curves are not background subtrackted ass visible in the plot. To do this we use the `CPP()` function from the [chipPCR](https://github.com/michbur/chipPCR) package [@roediger2015chippcr].
