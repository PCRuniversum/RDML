...
XML files can be compressed to save sapce. The **RMDL** package uses the `zip()` function from the **utils** package with default values to compress the RDML file. Therefore, the compression mode depends on the operating system.

XML becomes less efficient to work with at larger file sizes and complexer structured information (e.g., matrices).
...
In both cases we used R 3.2.1 (2015-06-18).
