...
=======
author: "Konstantin A. Blagodatskikh, Stefan Roediger, Michal Burdukiewicz"
date: "`r Sys.Date()`"
...
>>>>>>> d0d35c529359f424ec2ece317f18abeebcbdd4bd
---
...
```{r}
matplot(C54[, 1], C54[, -1], xlim = c(0,56), ylim = c(0, 0.7), 
	      xlab = "Cycle", ylab = "refMFI", pch = 19, type = "b",
	      main = "Amplification of human MLC-2v\nVideoScan HCU\nRaw data")
legend("topleft", c("D1 - Stock cDNA", "D2 - 1/10 cDNA", "D3 - 1/100 cDNA"), 
       col = 1:3, pch = 19)
```
...
To preprocess data we will use **CPP** function from **chipPCR** package. After that preprocessed data will be stored in new runs inside same experiment. For Cq calculation -- **diffQ2** function from [MBmca](https://github.com/michbur/MBmca) package. 
